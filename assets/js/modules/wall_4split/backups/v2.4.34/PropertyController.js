    ...
    generateBeamHtml: function(beam) {
        ...
        if (beam.fdStress && beam.fdStress.pillars && beam.fdStress.pillars.length > 0) {
            ...
            let table1 = `<table style="width:100%; border-collapse:collapse; font-size:9px; margin-bottom:12px; border:1px solid #ddd;">
                <thead>
                    <tr style="background:#f2f4f4; border-bottom:1px solid #ddd;">
                        ...
                        <th colspan="4" style="border:1px solid #ddd; padding:3px; text-align:center; background:#ebf5fb;">左加力 (B=${B_val.toFixed(2)})</th>
                        <th colspan="4" style="border:1px solid #ddd; padding:3px; text-align:center; background:#fdf2e9;">右加力 (B=${B_val.toFixed(2)})</th>
                    </tr>
                    <tr style="background:#f2f4f4; border-bottom:1px solid #ddd;">
            ...
            pillars.forEach((p, idx) => {
                const sign = idx < pillars.length / 2 ? 1 : -1;
                const l_Td = (p.seismicAxial * B_val * sign).toFixed(3);
                ...
                const r_Td = (p.seismicAxial * B_val * -sign).toFixed(3);
