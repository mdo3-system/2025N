...
window.AppState = {
    ...
    // [接地圧適正化 v2.4.10] 建物単位重量（kN/m2）。初期値を3.0に設定
    config: {
        buildingUnitWeight: 3.0,
        reqWallCoeffs: { '1F': { seismic: 0.15, wind: 0.20 }, '2F': { seismic: 0.15, wind: 0.20 } },
        projectedAreas: { '1F': { x: 0, y: 0 }, '2F': { x: 0, y: 0 } },
        floorAreas: { '1F': 0, '2F': 0 },
        weights: { roof: 500, solar: 0, ceilingIns: 100, exteriorWall: 600, wallIns: 70 }
    },
    ...
    reqWall: { 
        '1F': { 
            qX: 0, qY: 0, eq: 0, wx: 0, wy: 0, a_eff: 0, basis: '',
            div4: { vxt: 0, vxb: 0, vyl: 0, vyr: 0, rxt: 0, rxb: 0, ryl: 0, ryr: 0, isXOk: true, isYOk: true }
        },
        '2F': { 
            qX: 0, qY: 0, eq: 0, wx: 0, wy: 0, a_eff: 0, basis: '',
            div4: { vxt: 0, vxb: 0, vyl: 0, vyr: 0, rxt: 0, rxb: 0, ryl: 0, ryr: 0, isXOk: true, isYOk: true }
    ...
    init: function() {
        ...
        this.config.floorAreas['1F_attic'] = getVal('a-attic1') || 0;
        this.config.floorAreas['1F_balcony'] = getVal('a-balcony1') || 0;
        this.config.floorAreas['1F_porch'] = getVal('a-porch1') || 0;
        
        this.config.floorAreas['2F'] = getVal('a-f2') || 0;
        this.config.floorAreas['2F_attic'] = getVal('a-attic2') || 0;
        this.config.floorAreas['2F_balcony'] = getVal('a-balcony2') || 0;
        this.config.floorAreas['2F_void'] = getVal('a-void2') || 0;
        ...
        this.bearingFe = getVal('global-fe') || 20;
        this.fdThicknessM = getVal('global-fd-thickness-m') || 0.15;
